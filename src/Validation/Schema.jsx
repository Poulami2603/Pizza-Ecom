...
export const orderSchema = Yup.object({
    ...
    phone: Yup.number().min(2).max(20).required("Please Enter a Phone Number"),
    email: Yup.string().email().required("Please Enter Valid Email Address"),
    address1: Yup.string().min(10).max(30).required("Please Enter Your Address"),
    address2: Yup.string().min(10).max(30).required("Please Enter Your Address"),
    ...
    zip: Yup.number().min(2).max(20).required("Please Enter Your PIN"),
    country: Yup.string().min(2).max(10).required("Please Enter Your Country")
})